...
[OSGeo Code of Conduct Version 1.0](https://www.osgeo.org/resources/osgeo-code-of-conduct/).
...
- **Be empathetic, welcoming, friendly, and patient.** We work together to
  ...
  where people feel uncomfortable or threatened is not a productive one. Note
  that we have a multi-cultural, multi-lingual community and some of us are
  non-native speakers. We should be respectful when dealing with other community
...
- **Be collaborative.** Our work will be used by other people, and in turn we
  ...
  can build on the work to make it even better. Any decision we make will affect
...
- **Be inquisitive.** Nobody knows everything! Asking questions early avoids
  ...
  helpful, within the context of our shared goal of improving the project.
- **Be careful in the words that we choose.** Whether we are participating as
  ...
  take responsibility for our own speech. Be kind to others. Do not insult or
  put down other participants.
...
dealing with the situation, you may report your concerns to project maintainers.
Serious or persistent offenders may be expelled from project forums or
repositories.
